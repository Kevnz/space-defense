module.exports =  function (game) {
	var aliens, raptors, miniBosses;

    var spawn = function () { 
        var x = game.rnd.integerInRange(40, 600)  , y = game.rnd.integerInRange(0, 10);
        var _alien = aliens.create(x, y, 'atlas', 'bad-guy1-a.png');
    ...
    var spawnRaptor = function (x,y) {
        var _alien = raptors.create(x, y, 'atlas', 'raptor-1-a.png');
        _alien.anchor.setTo(0.5, 0.5);
        _alien.body.moves = true;
    ...
    var spawnMiniBoss = function () {
        var x = game.rnd.integerInRange(40, 600)  , y = game.rnd.integerInRange(0, 10);
        var _alien = miniBosses.create(x, y, 'bosses', 'boss-1-a.png');
        _alien.anchor.setTo(0.5, 0.5);
        _alien.body.moves = true;
	...
	return {
		init: function () {
            ...
            //music.volume = 0.5;
            //console.log(music.volume);
    		game.time.events.repeat(Phaser.Timer.SECOND * 1.5, 145, spawn, this);

    		game.time.events.repeat(Phaser.Timer.SECOND * 4, 35, spawnRaptorFormation, this);

            game.time.events.repeat(Phaser.Timer.SECOND * 10, 15, spawnMiniBoss, this);
		},
		update : function () {
